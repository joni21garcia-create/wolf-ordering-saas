...
export default function NewQRPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!image) {
      setError("Selecciona la imagen del código QR.");
      return;
    }
    ...
    try {
      ...
      const { data: lastQR, error: orderError } =
        await supabase
    ...
    <main className="qr-page">
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <p>
            Configura un nuevo código para recibir pagos.
          </p>
        </div>
        ...
        <section className="card">
          <div className="section-head">
            ...
            <div>
              ...
              <small>
                Datos que identificarán este método de pago.
              </small>
            </div>
          </div>
        ...
        <section className="card">
          <div className="section-head">
            ...
            <div>
              ...
              <small>
                Sube el código que utilizarán tus clientes.
              </small>
            </div>
          </div>
