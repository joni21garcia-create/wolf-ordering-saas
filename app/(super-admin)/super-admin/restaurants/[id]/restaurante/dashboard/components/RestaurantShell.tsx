...
export default function RestaurantShell({
  ...
  const operationModules = filteredModules.filter(
    (module) => module.category === "operation"
  );

  const settingsModules = filteredModules.filter(
    ...
    return (
      <a
        ...
        style={{
          ...
          color: active
            ? WolfColors.primary
            : WolfColors.textSecondary,
          background: active
            ? WolfColors.primarySoft
            : "transparent",
          borderLeft: active
      ...
      >
        <span
          style={{
            ...
            border: `1px solid ${
              active ? `${module.color}35` : WolfColors.border
            }`,
          }}
        >
          {module.icon}
      ...
      >
        <div
          style={{
            ...
            borderBottom: `1px solid ${WolfColors.border}`,
          }}
        >
          <div
            style={{
        ...
        <div
          style={{
            padding: `${WolfSpacing.lg}px ${WolfSpacing.lg}px ${WolfSpacing.sm}px`,
          }}
        >
          <div
            style={{
        ...
        <WolfScrollArea
          style={{
            flex: 1,
            padding: `0 ${WolfSpacing.md}px ${WolfSpacing.md}px`,
            boxSizing: "border-box",
          }}
        >
          <ModuleGroups />
        ...
        <div
          style={{
            flexShrink: 0,
            padding: `${WolfSpacing.sm}px ${WolfSpacing.md}px ${WolfSpacing.md}px`,
            borderTop: `1px solid ${WolfColors.border}`,
          }}
        >
          <button
            type="button"
  ...
  return (
    <div
      style={{
        minHeight: "100dvh",
        background: WolfColors.background,
        color: WolfColors.text,
      }}
    >
      {!isMobile && (
        <aside
          style={{
            ...
            width: 270,
            zIndex: 40,
            borderRight: `1px solid ${WolfColors.border}`,
      ...
      {isMobile && (
        <>
          ...
          >
            ...
            >
              <span style={{ color: WolfColors.primary }}>W</span>
              Wolf Ordering
            </div>
          ...
          <WolfSheet
            ...
            title="Módulos"
            subtitle={`${allowedModules.length} módulos disponibles`}
            maxWidth={390}
            ariaLabel="Módulos del restaurante"
          >
            <div style={{ padding: "0 14px 18px" }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: WolfRadius.md,
                  background: "rgba(255,255,255,.025)",
                  color: WolfColors.textSecondary,
                  cursor: "pointer",
                  fontFamily: WolfTypography.fontFamily,
                  fontSize: 12,
                  fontWeight: 600,
      ...
      <main
        style={{
          ...
          boxSizing: "border-box",
          padding: isMobile ? "0 14px 28px" : "28px 32px 36px",
        }}
      >
        {children}
      </main>
...
function ModuleGroup({
  ...
  return (
    ...
    >
      <div
        style={{
          padding: compact ? "8px 4px 5px" : "10px 6px 6px",
          color: WolfColors.textMuted,
          fontSize: 8,
          fontWeight: 800,
          letterSpacing: "1px",
