...
export default function ThemeSettingsClient({
  ...
  const BUTTON_STYLES = [
    { id: "Solid", label: "Solido (Estandar)" },
  ...
  const ANIMATION_EFFECTS = [
    ...
    { id: "bounce", label: "Efecto Rebote Elastico" },
          ...
          <div style={S.section}>
            ...
            <div className="hex-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: "12px" }}>
              {[
                ...
                { l: "Texto", k: "text_color" as keyof ThemeForm },
              ].map((item) => (
        ...
        <div className="preview-container" style={{ width: "100%" }}>
          <div style={{
            ...
            <div style={{ 
              ...
              <p style={{ fontSize: "0.8rem", color: "#9ca3af", marginBottom: "16px" }}>Los cambios de botones, tipografí­as y efectos se renderizan dinámicamente aquí­.</p>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", color: "#6b7280", fontSize: "0.75rem", flexWrap: "wrap", gap: "6px" }}>
              <span>Tipografí­a: <strong style={{ color: "#fff" }}>{form.font_family}</strong></span>
