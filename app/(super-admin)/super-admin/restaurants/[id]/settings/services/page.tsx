...
>
  ...
  >
    ...
    >
      ...
      <span>
        📏 Tarifa por distancia (Próximamente)
      </span>
    </label>
  </div>
</div>
...
{settings.delivery_mode ===
  ...
  >
    ...
    >
      El costo del envío no será calculado automáticamente.
      <br />
      <br />
      Después de realizar el pedido, el cliente enviará el resumen por
      WhatsApp y compartirá su ubicación.
      <br />
      <br />
      El restaurante calculará el valor del envío y notificará al cliente
      con el total final.
    </p>
  </div>
)}
...
"fixed" ? (
  ...
  >
    ...
    >
      El costo del envío será confirmado
      por WhatsApp una vez que el cliente
