  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Aún no has registrado ningún restaurante
          dentro de la plataforma.

          <br />

          Comienza creando el primero para empezar
          a administrar pedidos, configuración,
